...
class CrowdSim:
    ...
    def step(self, action, eval=False, save_data=False):
        ...
        return self.scan_current / self.laser_max_range, robot_goal_emotion_state, reward, done, info
    ...
    def reset(self, seed=-1, save_data=False):
        ...
        return self.scan_current / self.laser_max_range, robot_goal_emotion_state
