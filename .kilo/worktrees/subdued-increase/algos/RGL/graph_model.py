...
class RGL(nn.Module):
    def __init__(self, args, robot_state_dim, human_state_dim, num_layer=2, X_dim=32, 
                       wr_dims=[64, 32], wh_dims=[64, 32], final_state_dim=32):
        ...
        layerwise_graph = args.layerwise_graph
