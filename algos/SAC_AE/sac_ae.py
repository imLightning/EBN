...
class SacAeAgent(object):
    ...
    def update_critic(self, obs, robot_goal__emotion_state, action, reward, next_obs, next_robot_goal_emotion_state, not_done, writer, step):
        with torch.no_grad():
    ...
    def update_actor_and_alpha(self, obs, robot_goal__emotion_state, writer, step):
    ...
    def update(self, replay_buffer, writer, step):
        ...
        self.update_critic(obs, robot_goal__emotion_state, action, reward, next_obs, next_robot_goal_emotion_state, not_done, writer, step)

        if step % self.actor_update_freq == 0:
            self.update_actor_and_alpha(obs, robot_goal__emotion_state, writer, step)
