...
from algos.LIDAR_SAC.sac import SacAeAgent
from algos.LIDAR_SAC.utils import ReplayBuffer, eval_policy_mode, set_seed_everywhere
from info import *
from env_lidar_sac import CrowdSim
...
def main():
    ...
    parser.add_argument('--policy', default='lidar_sac', type=str)
    ...
    obs_shape = (1, args.frame_stack, args.lidar_dim)
